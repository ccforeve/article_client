<template>
  <div id="headlines" class="flexv wrap">
    ...
    <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
      <div class="flexitemv mainbox">
        <div class="listbox" id="listbox" v-for="(item, index) of dataList" :key="index">
          <router-link :to="'/article_detail/' + item.user_article_id + '/user'" class="flex">
    ...
    <div class="flex tabbars">
      ...
      <a :herf="is_member ? 'tel:' + user_info.phone : 'javascript:;'" class="flexv center item" @click="call_phone">
      ...
      <a href="" id="data" class="flexv center item">
