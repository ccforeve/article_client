<template>
  ...
  <div class="flexitemv scroll">
    ...
    <div class="user-punch-info">
      <div
        class="img user-punch-info__img"
    ...
    <div
      class="blank"
      style="background: #eee; height: 4vw"
    ></div>
    ...
    <div class="morning-content">
      ...
      <div class="morning-poster">
        <div class="morning-poster__title">
          最新增员海报已更新！ <router-link
            to="/poster"
            class="morning-poster__link"
          >点这里生成&gt;&gt;</router-link>
        </div>
      </div>
    </div>
    ...
    generateMorningPoster(morningImgSrc) {
      ...
      getPublicQrcode().then(function(q) {
        ...
        setTimeout(function() {
          ...
          ctx.fillText(
            _this.moment(_this.current_user_punch.created_at).format("D"),
            canvas.width - 200,
            100
          );
          //绘制月份
          ...
          ctx.font = "26px Arial";
          ctx.fillText(
            _this.moment(_this.current_user_punch.created_at).format("MMM"),
            canvas.width - 90,
            100
          );
          //绘制坚持早起几天
          ctx.font = "26px Arial";
          ctx.fillText(
            "坚持早起" + _this.current_user_punch.total_punch + "天",
            canvas.width - 200,
            140
          );
          //绘制底部半透明遮罩
